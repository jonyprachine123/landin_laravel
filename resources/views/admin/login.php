...
<body>
    <div class="container">
        <div class="login-container">
            ...
            <?php
                // Always use the current URI as the form action to ensure it works in all environments
                $formAction = $_SERVER['REQUEST_URI'];
                
                // If we're in debug mode, output some helpful information
                if (isset($config) && $config['debug']) {
                    // Only log, don't display
                    error_log("Login form action: " . $formAction);
                }
            ?>
